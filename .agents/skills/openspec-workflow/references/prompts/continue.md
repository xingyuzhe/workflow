...
- Authoritative OpenSpec status, the next artifact instructions, current artifacts, and repository rules.

## Outputs

- The next incomplete artifact, or the specific artifact requested by the user.
- Reconciled optional local state when present.

## Acceptance

- OpenSpec status recognizes the targeted artifact as complete.
