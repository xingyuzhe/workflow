...
The system SHALL ship a project-local `workflow-spec` schema. The schema SHALL define artifact dependencies, ownership, required sections, and parser-sensitive formatting without tutorial-style reasoning or implementation instructions.
