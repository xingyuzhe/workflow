...
When grilling produces actionable decisions or open questions, the agent SHALL write or update `.workflow/changes/<name>/review-notes.md` with structured findings. Review notes SHALL NOT replace proposal, design, or specs as the source of truth for requirements.
