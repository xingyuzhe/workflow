...
description: Implement tasks from an OpenSpec change using the experimental artifact workflow. Use when the user wants to execute tasks from a change proposal.
license: MIT
