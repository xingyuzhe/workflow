...
description: Archive a completed OpenSpec change. Use when all tasks in a change are done and the change should be moved to the archive.
license: MIT
...
2. **Check artifact completion status**
   ...
   **If any artifacts are not `done`:**
   ...
   - Use 向用户提问确认 to confirm user wants to proceed
...
Do NOT auto-run cleanup — just inform. The developer decides whether and when to handle the branch.
